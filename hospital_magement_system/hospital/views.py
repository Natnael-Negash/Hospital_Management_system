...
def admin_signup_view(request):
    form = forms.AdminSignupForm(request.POST or None)
...
# for checking if the use is the doctor, admin or patient
...
# after entering creditials we check whether username and password is of admin. doctor or patient
...
def admin_dashboard_view(request):
    # for both table in the admin dashboard
...
#this view for sidebar click on the admin page
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
def reject_patient_view(request,pk):
    ...
    return redirect('admin-approve-patient')
          ...
          ########## FOR DISCHARCHING PATIENT BY ADMIN STAR ##########
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
def patient_discharge_view(request):
   ...
   ############### ABOUT US AND CONTACT US VIEWS STAR ############
